...
static boolType		count_edges;
static struct grid	grid;
static char *		me;
static int		number_of_edges;
static boolType		Print_Grid_Graph	= TRUE;
static boolType		Print_ORLibrary_Format	= TRUE;
static boolType		Print_SteinLib_Format	= FALSE;
static boolType		Print_Unscaled = FALSE;
