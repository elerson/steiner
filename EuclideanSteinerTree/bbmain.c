...
extern boolType		Check_Root_Constraints;
extern boolType		Choose_Branch_Vars_Carefully;
extern double		Initial_Upper_Bound;
extern boolType		Print_Root_LP;
...
#ifdef LPSOLVE
extern boolType		Use_Perturbations;
extern boolType		Use_Scaling;
#endif
