...
boolType			check_for_better_IFS (double *,
					      struct bbinfo *,
					      double *);
...
boolType		Check_Root_Constraints = FALSE;
boolType		Choose_Branch_Vars_Carefully = TRUE;
double		Initial_Upper_Bound = DBL_MAX;
boolType		Print_Root_LP = FALSE;

volatile boolType	force_branch_flag;
...
static int		choose_branching_variable (struct bbinfo *,
						   double *,
						   double *);
static boolType		compare_branch_vars (struct bbinfo *,
					     int,
					     struct bvar *);
...
static struct constraint * do_separations (struct bbinfo *,
					   cpu_time_t **);
static boolType		eval_branch_var (struct bbinfo *,
					 int,
					 int,
					 struct basis_save *,
					 double);
...
static boolType		integer_feasible_solution (double *,
						   bitmap_t *,
						   bitmap_t *,
						   struct cinfo *,
						   int *);
