...
struct greedy_fst {
	...
	boolType		chosen; /* Is this FST chosen by the algorithm? */
};
...
boolType		mst_connected	/* Is induced subgraph of MST connected? */
)
{
int		j;
dist_t		smt_l;
...
int *			sortedfsts;
boolType *			new_chosen;
boolType			convex_region;
boolType			in_same_block;
...
struct pset *		pts;
	...
	*/
	...
	new_chosen = NEWA (fst_count, boolType);
