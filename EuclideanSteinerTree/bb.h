...
struct bbnode {
	...
	boolType		optimal; /* optimal LP relaxation found? */
...
struct bbstats {
	...
	boolType		root_opt;	/* Is root_z optimal? */
...
extern boolType		Seed_Pool_With_2SECs;


extern dist_t		branch_and_cut (struct bbinfo *);
extern boolType		check_for_better_IFS (double *,
					      struct bbinfo *,
					      double *);
...
extern volatile boolType		force_branch_flag;
